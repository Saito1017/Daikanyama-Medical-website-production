        ...
        <section class="mainvisual">
            <div class="mainvisual-swiper swiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <picture class="mainvisual-image">
                            <source media="(min-width:769px)" srcset="<?php echo get_template_directory_uri()?>/assets/image/record/record-slider-img2.jpg">
                            <source media="(max-width:768px)" srcset="<?php echo get_template_directory_uri()?>/assets/image/record/record-slider-img2.jpg">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/record/record-slider-img2.jpg" alt="mainvisual-bg" loading="lazy">
                        </picture>
                    </div>
                    <div class="swiper-slide">
                        <picture class="mainvisual-image">
                            <source media="(min-width:769px)" srcset="<?php echo get_template_directory_uri()?>/assets/image/record/record-slider-img3.jpg">
                            <source media="(max-width:768px)" srcset="<?php echo get_template_directory_uri()?>/assets/image/record/record-slider-img3.jpg">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/record/record-slider-img3.jpg" alt="mainvisual-bg" loading="lazy">
                        </picture>
                    </div>
                    <div class="swiper-slide">
                        <picture class="mainvisual-image">
                            <source media="(min-width:769px)" srcset="<?php echo get_template_directory_uri()?>/assets/image/record/record-slider-img4.jpg">
                            <source media="(max-width:768px)" srcset="<?php echo get_template_directory_uri()?>/assets/image/record/record-slider-img4.jpg">
                            <img src="<?php echo get_template_directory_uri()?>/assets/image/record/record-slider-img4.jpg" alt="mainvisual-bg" loading="lazy">
                        </picture>
                    </div>                    
                </div>
                    ...
                    <ul class="banner-list">
                        <li>
                            <div class="banner-item banner01">
                                ...
                                <div class="block">
                                    <h4 class="label">無料受験相談</h4>
                                    <div class="action">
                                        <a href="<?php echo home_url() ?>/consultation" class="banner-btn">
                        ...
                        <li>
                            <div class="banner-item banner02">
                                ...
                                <div class="block">
                                    <h4 class="label">無料体験授業</h4>
                                    <div class="action">
                                        <a href="<?php echo home_url() ?>/trial" class="banner-btn">
                                            <span>お申し込みはこちらから</span>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <li>
                            <div class="banner-item banner03">
                                ...
                                <div class="block">
                                    ...
                                    <div class="action">
                                        <a href="<?php echo home_url() ?>/contact" class="banner-btn">
                                            <span>お申し込みはこちらから</span>
                                        </a>
                                    </div>
                                </div>
